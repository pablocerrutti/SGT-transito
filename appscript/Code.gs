...
function doGet(e) {
  ...
  try{
    switch(accion){
      ...
      case 'actualizarElemento': return json(permisoModuloApi_(e,'movilidad') || bloquearConsultaMapaApi_(e) || actualizarElemento(e));
      case 'eliminarElemento': return json(permisoModuloApi_(e,'movilidad') || bloquearConsultaMapaApi_(e) || eliminarElemento(e));
