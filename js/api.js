...
async function apiActualizarUsuario(usuario){const s=actorSesionApi_();return api('actualizarUsuario',Object.assign({},usuario,{actorUsuario:s.usuario,actorRol:s.rol}));}
async function apiEliminarUsuario(id,passwordConfirmacion=''){const s=actorSesionApi_();return api('eliminarUsuario',{id,passwordConfirmacion,actorUsuario:s.usuario,actorRol:s.rol});}
