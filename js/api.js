...
async function apiLogout(){const sesion=JSON.parse(localStorage.getItem('usuarioActual')||'null')||{};return registrarAuditoriaCliente_('logout',{},sesion,{}).then(function(){return{ok:true};});}
...
async function apiGuardarElemento(elemento){return api('guardarElemento',Object.assign({},elemento,{rol:rolSesionApi_()}));}
async function apiActualizarElemento(elemento){return api('actualizarElemento',Object.assign({},elemento,{rol:rolSesionApi_()}));}
async function apiEliminarElemento(id){return api('eliminarElemento',{id,rol:rolSesionApi_()});}
...
async function apiGuardarInspeccion(datos){return api('guardarInspeccion',Object.assign({},datos,{rol:datos.rol||rolSesionApi_()}));}
...
async function apiGuardarZonaEstacionamiento(zona){return api('guardarZonaEstacionamiento',Object.assign({},zona,{rol:rolSesionApi_()}));}
async function apiEliminarZonaEstacionamiento(id){return api('eliminarZonaEstacionamiento',{id,rol:rolSesionApi_()});}
async function apiObtenerCordonesRojos(){return api('obtenerCordonesRojos');}
async function apiGuardarCordonRojo(cordon){return api('guardarCordonRojo',Object.assign({},cordon,{rol:rolSesionApi_()}));}
async function apiEliminarCordonRojo(id){return api('eliminarCordonRojo',{id,rol:rolSesionApi_()});}
